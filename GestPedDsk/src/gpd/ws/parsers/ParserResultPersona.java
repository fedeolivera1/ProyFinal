...
public class ParserResultPersona {
	...
	public static Map<Long, Integer> parseResultRecPersonasSinc(ResultRecPersonasASinc result) throws ParsersException {
		...
		try {
			...
			logger.error("Excepcion al parsear en parseResultRecPersonasSinc: " + e.getMessage());
			throw new ParsersException(e);
		}
		return hmResult;
	}
